    ...
    beforeAll(function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    throw new Error("Unable to run test --------" + err_1);
    ...
    it("should create new user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_2 = _a.sent();
                    throw new Error("Unable to run test --------" + err_2);
                case 3: return [2 /*return*/];
            }
        });
    }); });
    it("should return all users", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    users = _a.sent();
                    expect(users === null || users === void 0 ? void 0 : users.length).toBeGreaterThan(0);
                    return [3 /*break*/, 3];
                case 2:
                    err_3 = _a.sent();
                    throw new Error("Unable to run test --------" + err_3);
                case 3: return [2 /*return*/];
            }
        });
    }); });
    it("should return user of given ID", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_4 = _a.sent();
                    throw new Error("Unable to run test --------" + err_4);
                case 3: return [2 /*return*/];
            }
        });
    }); });
    it("should delete user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_5 = _a.sent();
                    throw new Error("Unable to run test --------" + err_5);
